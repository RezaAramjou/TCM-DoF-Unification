# run_unification_v14.py
import numpy as np
from joblib import Parallel, delayed
from tqdm import tqdm
# Ensure this import points to the new, final, robust solver file
from cma_solver_v14_final import CmaSolver 
...
# --- Step 1: Define Sweep ---
print('--- Unification Analysis (v14.0 Solver) ---')
...
plt.title('Unification of DoF: Internal Modes vs. External Field Complexity (v14.0)', fontweight='bold', fontsize=14)
plt.legend(loc='upper left')
plt.grid(True)
plt.tight_layout()
plt.savefig('Fig_Unification_DoF_v14_final.png', dpi=300)

print('Plots saved to Fig_Unification_DoF_v14_final.png. Analysis is complete.')
plt.show()
