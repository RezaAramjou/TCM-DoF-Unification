...
from cma_solver_v21_stable import CmaSolverStable 
...
def run_benchmark(a_const, segments_per_lambda, feed_gap):
    ...
    plt.savefig('Fig_Benchmark_v21.png', dpi=300)
    print("Benchmark plot saved to Fig_Benchmark_v21.png")
    plt.show()


# --- Step 1: Define Sweep Parameters ---
print('--- Unification & Q-Factor Analysis (v21.0 Stable Edition) ---')
f0 = 300e6
lambda0 = 299792458.0 / f0
...
for r in tqdm(results, desc="Analyzing Results"):
    ...
    E_theta_mode1 = CmaSolverStable.calculate_radiation_properties(
...
styles = CmaSolverStable.get_plot_styles()
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 12))
fig.suptitle('CMA Unification & Q-Factor Analysis (v21.0 Stable Edition)', fontsize=16, fontweight='bold')
...
plt.savefig('Fig_Report_v21_Stable.png', dpi=300)

print('Stable report saved to Fig_Report_v21_Stable.png. Analysis is complete.')
plt.show()
